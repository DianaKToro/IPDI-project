...
from models import images, skullRemoval
...
class Removal(GUI):
    def __init__(self, parent, controller):
        ...
        frame2 = LabelFrame(self, style.frame_styles, text="Imagen con remoción del cráneo")
        frame2.place(rely=0.05, relx=0.45, height=600, width=550)
        
        frame3 = LabelFrame(self, style.frame_styles, text="Configuración de remoción del cráneo")
        ...
        self.segmented_label = Label(frame2, text= "Imagen removida", justify=CENTER, **style.frame_styles,)
        ...
        self.bt_segmentation = Button(frame3, **style.button_style, text="Remover")
        ...
        self.bt_segmentation['command'] = lambda : (skullRemoval.Removal.skullRemoval(call_methods.image, call_methods_seg), 
                                                    call_methods_seg.set_slider(), call_methods_seg.show_img(self.slider_segmented.get()))
        img_button['command'] = lambda : call_methods_seg.save_image("Removal")
