...
class Matching(GUI):
    def __init__(self, parent, controller):
        ...
        frame2 = LabelFrame(self, style.frame_styles, text="Estandarización de intensidades usando coincidencia de histogramas")
        frame2.place(rely=0.05, relx=0.45, height=600, width=550)
        
        frame3 = LabelFrame(self, style.frame_styles, text="Configuración de coincidencia de histogramas")
        frame3.place(rely=0.85, relx=0.02, height=80, width=400)

        label1 = Label(frame1, text= "Selecciona la imagen a transformar", justify=CENTER, **style.frame_styles)
        ...
        label2 = Label(frame1, text= "Selecciona la imagen plantilla", justify=CENTER, **style.frame_styles)
        ...
        self.bt_segmentation['command'] = lambda : (intensitiesStandarization.IntensitiesStandarization.hist_match(call_methods_source.mri_image, call_methods_template.mri_image, call_methods_seg), 
                                                    call_methods_seg.set_slider(), call_methods_seg.show_img(self.slider_segmented.get()))
        img_button['command'] = lambda : call_methods_seg.save_image("Matching")
