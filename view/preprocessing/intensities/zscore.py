...
class Zscore(GUI):
    def __init__(self, parent, controller):
        ...
        frame2 = LabelFrame(self, style.frame_styles, text="Estandarización de intensidades usando Z-score")
        frame2.place(rely=0.05, relx=0.45, height=600, width=550)
        
        frame3 = LabelFrame(self, style.frame_styles, text="Configuración de Z-score")
        ...
        self.bt_segmentation['command'] = lambda : (intensitiesStandarization.IntensitiesStandarization.zscore(call_methods.mri_image, call_methods_seg), 
                                                    call_methods_seg.set_slider(), call_methods_seg.show_img(self.slider_segmented.get()))
        img_button['command'] = lambda : call_methods_seg.save_image("Zscore")
