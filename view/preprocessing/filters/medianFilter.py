...
from models import denoising, images 
from view.app import GUI

class MedianFilter(GUI):
    def __init__(self, parent, controller):
        ...
        frame2 = LabelFrame(self, style.frame_styles, text="Remoción del ruido con filtro mediano")
        frame2.place(rely=0.05, relx=0.45, height=600, width=550)
        
        frame3 = LabelFrame(self, style.frame_styles, text="Configuración de filtro mediano")
        ...
        self.bt_segmentation = Button(frame3, **style.button_style, text="Filtrar")
        ...
        self.bt_segmentation['command'] = lambda : (denoising.Denoising.median_filter(call_methods.mri_image, call_methods_seg), 
                                                    call_methods_seg.set_slider(), call_methods_seg.show_img(self.slider_segmented.get()))
        img_button['command'] = lambda : call_methods_seg.save_image("Median")
